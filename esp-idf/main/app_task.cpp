...
static void process_command(const network_cmd_t *cmd, BotiEyes::BotiEyes *eyes)
{
    ...
    case CMD_SET_PRESET:
    {
        ...
        {
        case 0:
            eyes->happy(intensity_f);
            break;
        case 1:
            eyes->sad(intensity_f);
            break;
        case 2:
            eyes->angry(intensity_f);
            break;
        case 3:
            eyes->calm(intensity_f);
            break;
        case 4:
            eyes->excited(intensity_f);
            break;
        case 5:
            eyes->tired(intensity_f);
            break;
        case 6:
            eyes->surprised(intensity_f);
            break;
        case 7:
            eyes->anxious(intensity_f);
            break;
        case 8:
            eyes->content(intensity_f);
            break;
        case 9:
            eyes->curious(intensity_f);
            break;
        case 10:
            eyes->thinking(intensity_f);
            break;
        case 11:
            eyes->confused(intensity_f);
            break;
        case 12:
            eyes->neutral(intensity_f);
            break;
        default:
...
void app_task(void *arg)
{
    ...
    while (1)
    {
        ...
        // T094: Feed watchdog only after registration complete (FR-040)
